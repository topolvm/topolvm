...
> :memo:
>
> This document is an adaptation of the existing README.md to Helm Chart.
> After removing the kustomize manifests, this document will be renamed to README.md.
