...
EXTERNAL_PROVISIONER_VERSION = 3.4.1
EXTERNAL_RESIZER_VERSION = 1.7.0
NODE_DRIVER_REGISTRAR_VERSION = 2.6.3
LIVENESSPROBE_VERSION = 2.9.0
EXTERNAL_SNAPSHOTTER_VERSION = 6.2.1
CSI_SIDECARS = \
