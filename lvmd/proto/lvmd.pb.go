...
type GetWatchersCountResponse struct {
...
func (m *GetWatchersCountResponse) Reset()         { *m = GetWatchersCountResponse{} }
func (m *GetWatchersCountResponse) String() string { return proto.CompactTextString(m) }
func (*GetWatchersCountResponse) ProtoMessage()    {}
func (*GetWatchersCountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb3c510e545f3bbd, []int{9}
}

func (m *GetWatchersCountResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetWatchersCountResponse.Unmarshal(m, b)
}
func (m *GetWatchersCountResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetWatchersCountResponse.Marshal(b, m, deterministic)
}
func (m *GetWatchersCountResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetWatchersCountResponse.Merge(m, src)
}
func (m *GetWatchersCountResponse) XXX_Size() int {
	return xxx_messageInfo_GetWatchersCountResponse.Size(m)
}
func (m *GetWatchersCountResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetWatchersCountResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetWatchersCountResponse proto.InternalMessageInfo

func (m *GetWatchersCountResponse) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*GetWatchersCountResponse)(nil), "proto.GetWatchersCountResponse")
}
...
var fileDescriptor_cb3c510e545f3bbd = []byte{
	...
	,
}
...
type VGServiceClient interface {
	...
	// Get the watch group count.
	GetWatchersCount(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetWatchersCountResponse, error)
...
func (c *vGServiceClient) GetWatchersCount(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetWatchersCountResponse, error) {
	out := new(GetWatchersCountResponse)
	err := c.cc.Invoke(ctx, "/proto.VGService/GetWatchersCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VGServiceServer interface {
	...
	// Get the watch group count.
	GetWatchersCount(context.Context, *Empty) (*GetWatchersCountResponse, error)
	// Stream the volume group metrics.
...
func _VGService_GetWatchersCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VGServiceServer).GetWatchersCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VGService/GetWatchersCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VGServiceServer).GetWatchersCount(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _VGService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWatchersCount",
			Handler:    _VGService_GetWatchersCount_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
