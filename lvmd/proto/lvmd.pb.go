...
type WatchItem struct {
	...
	PvCount     uint64        `protobuf:"varint,4,opt,name=pv_count,json=pvCount,proto3" json:"pv_count,omitempty"`       // Number of PVs in volume group.
	ThinPool    *ThinPoolItem `protobuf:"bytes,5,opt,name=thin_pool,json=thinPool,proto3" json:"thin_pool,omitempty"`
}
...
func (x *WatchItem) GetPvCount() uint64 {
	if x != nil {
		return x.PvCount
	}
	return 0
...
var file_lvmd_proto_lvmd_proto_rawDesc = []byte{
	...
	0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xb9, 0x01, 0x0a, 0x09, 0x57, 0x61, 0x74, 0x63,
	...
	0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x76, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x70, 0x76, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x30, 0x0a, 0x09, 0x74, 0x68, 0x69, 0x6e, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x05,
