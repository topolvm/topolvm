...
func (c *lVServiceClient) CreateLV(ctx context.Context, in *CreateLVRequest, opts ...grpc.CallOption) (*CreateLVResponse, error) {
	...
	err := c.cc.Invoke(ctx, LVService_CreateLV_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lVServiceClient) RemoveLV(ctx context.Context, in *RemoveLVRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, LVService_RemoveLV_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lVServiceClient) ResizeLV(ctx context.Context, in *ResizeLVRequest, opts ...grpc.CallOption) (*ResizeLVResponse, error) {
	...
	err := c.cc.Invoke(ctx, LVService_ResizeLV_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lVServiceClient) CreateLVSnapshot(ctx context.Context, in *CreateLVSnapshotRequest, opts ...grpc.CallOption) (*CreateLVSnapshotResponse, error) {
	...
	err := c.cc.Invoke(ctx, LVService_CreateLVSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLVServiceServer must be embedded to have
...
func (UnimplementedLVServiceServer) testEmbeddedByValue()                   {}
...
func RegisterLVServiceServer(s grpc.ServiceRegistrar, srv LVServiceServer) {
	// If the following call pancis, it indicates UnimplementedLVServiceServer was
...
type VGServiceClient interface {
	...
	Watch(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchResponse], error)
}
...
func (c *vGServiceClient) GetLVList(ctx context.Context, in *GetLVListRequest, opts ...grpc.CallOption) (*GetLVListResponse, error) {
	...
	err := c.cc.Invoke(ctx, VGService_GetLVList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vGServiceClient) GetFreeBytes(ctx context.Context, in *GetFreeBytesRequest, opts ...grpc.CallOption) (*GetFreeBytesResponse, error) {
	...
	err := c.cc.Invoke(ctx, VGService_GetFreeBytes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vGServiceClient) Watch(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WatchResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &VGService_ServiceDesc.Streams[0], VGService_Watch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Empty, WatchResponse]{ClientStream: stream}
...
type VGService_WatchClient = grpc.ServerStreamingClient[WatchResponse]
...
type VGServiceServer interface {
	...
	// Stream the volume group metrics.
	Watch(*Empty, grpc.ServerStreamingServer[WatchResponse]) error
	mustEmbedUnimplementedVGServiceServer()
}

// UnimplementedVGServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedVGServiceServer) Watch(*Empty, grpc.ServerStreamingServer[WatchResponse]) error {
	return status.Errorf(codes.Unimplemented, "method Watch not implemented")
}
func (UnimplementedVGServiceServer) mustEmbedUnimplementedVGServiceServer() {}
func (UnimplementedVGServiceServer) testEmbeddedByValue()                   {}
...
func RegisterVGServiceServer(s grpc.ServiceRegistrar, srv VGServiceServer) {
	// If the following call pancis, it indicates UnimplementedVGServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _VGService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(VGServiceServer).Watch(m, &grpc.GenericServerStream[Empty, WatchResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type VGService_WatchServer = grpc.ServerStreamingServer[WatchResponse]
