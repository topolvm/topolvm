...
// LVM commands and options used to build the command line arguments.
const (
	cmdLVCreate = "lvcreate"

	optUnits        = "--units"
	optNoSuffix     = "--nosuffix"
	optReportFormat = "--reportformat"
	optConfigReport = "--configreport"
	// optNoFields omits all fields of a report section, because fullreport
	// doesn't have an option to omit an entire section.
	optNoFields = "-o,"
